...
export const createVacationNormalizing = createEntityNormalization(CREATE_VACATION_REQUEST);

export const updateVacation = updateEntity(UPDATE_VACATION_REQUEST);

export const updateVacationNormalizing = updateEntityNormalization(UPDATE_VACATION_REQUEST);
