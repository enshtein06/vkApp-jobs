...
export const initialVkUserLoadingSelector = state => initialVkUser(state).isLoading;
export const initialVkUserLoadedSelector = state => initialVkUser(state).isLoaded;
...
export const vkUserIdSelector = state => initialVkUserEntitySelector(state).vkUserId;
