...
class CreateVacation extends PureComponent{
    ...
    errorAlert = (
        ...
        >
            ...
            <ul>
                <li>
                    Вы уже создали больше 3 вакансии. 
                    Чтобы создать больше можете удалить одну из созданных или 
                    Купить подписку
                </li>
    ...
    static getDerivedStateFromProps (props, state) {
        if(props.isLoading !== state.isLoading) {
            return {
                ...
                isErrorOccured: !props.isLoading && 
                    !!state.isLoading && 
                    !!props.error
            }
        }
